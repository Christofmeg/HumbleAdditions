...
public class ModConfiguredFeatures {
	...
	public static final RegistryObject<ConfiguredFeature<?, ?>> ICEBERG_SMOOTH =
			CONFIGURED_FEATURES.register("iceberg_smooth", () -> new ConfiguredFeature<>(
					ModFeatures.ICEBERG.get(), new BlockStateConfiguration(BlockRegistry.SMOOTH_ICE.get().defaultBlockState())));
