...
public class BlockRegistry {
	...
	public static final RegistryObject<Block> AUTO_SMITHING_TABLE_BLOCK = registerBlock("auto_smithing_table_block", () -> new Block(BlockBehaviour.Properties.copy(Blocks.SMITHING_TABLE)), props());
